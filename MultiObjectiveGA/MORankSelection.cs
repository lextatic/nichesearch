...
namespace MultiObjectiveGA
{
	...
	/// </remarks>
	/// 
	public class MORankSelection : ISelectionMethod
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MORankSelection"/> class.
		/// </summary>
		public MORankSelection( int objectiveIndex )
	    {
